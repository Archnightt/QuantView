...
function MoverList({ items, type }: { items: Mover[], type: 'gainers' | 'losers' }) {
  ...
  return (
    <div className="h-auto max-h-[400px] overflow-y-auto pr-2 space-y-2 scrollbar-thin scrollbar-thumb-secondary">
      {items.map((item) => (
        <Link
          key={item.symbol}
  ...
  return (
    <Card className="flex flex-col shadow-sm dark:bg-card">
      ...
      <CardContent className="flex-1 p-4 pt-0">
        <Tabs defaultValue="gainers" className="w-full flex flex-col">
          ...
          <div className="overflow-y-auto pt-3 max-h-[400px] scrollbar-thin scrollbar-thumb-secondary">
