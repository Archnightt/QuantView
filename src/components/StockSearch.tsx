  ...
  return (
    <>
      ...
      <button
        ...
        className="group relative flex items-center gap-3 px-4 py-2 h-10 text-sm font-medium text-muted-foreground bg-card border border-border/40 rounded-full shadow-sm hover:shadow-md hover:border-primary/50 transition-all duration-300 w-full"
      >
